...
from moto import mock_s3, mock_sns, mock_sqs, mock_dynamodb
from src.model.aws.s3_manager import S3Manager
from src.model.aws.sns_manager import SNSManager
from src.model.aws.sqs_manager import SQSManager
    ...
    def test_model_happy_path(self):
        ...
        ddbm.update_item(
            ...
            expression_attribute_values={
                ...
                ':zp': {'S': 'level_1/David_Starr_Jordan/DS0604/EK60/DSJ0604-D20060406-T035914.zarr'},
            },
            update_expression=(
                'SET '
                '#CH = :ch, '
        ...
        ddbm.update_item(
            ...
            expression_attribute_values={
                ...
                ':zb': {'S': 'r2d2-dev-echofish2-118234403147-echofish-dev-output'},
                ':zp': {'S': 'level_1/David_Starr_Jordan/DS0604/EK60/DSJ0604-D20060406-T133530.zarr'},
            },
            update_expression=(
                'SET '
                '#CH = :ch, '
        ...
        ddbm.update_item(
            ...
            expression_attribute_values={
                ...
                ':zb': {'S': 'r2d2-dev-echofish2-118234403147-echofish-dev-output'},
                ':zp': {'S': 'level_1/Okeanos_Explorer/EX1404L2/EK60/EX1404L2_EK60_-D20140908-T173907.zarr'},
            },
            update_expression=(
                'SET '
                '#CH = :ch, '
        ...
        ddbm.update_item(
            ...
            expression_attribute_values={
                ...
                ':zb': {'S': 'r2d2-dev-echofish2-118234403147-echofish-dev-output'},
                ':zp': {'S': 'level_1/Henry_B._Bigelow/HB0707/EK60/D20070712-T061745.zarr'},
            },
            update_expression=(
                'SET '
                '#CH = :ch, '
        ...
        ddbm.update_item(
            ...
            expression_attribute_values={
                ...
                ':zb': {'S': 'r2d2-dev-echofish2-118234403147-echofish-dev-output'},
                ':zp': {'S': 'level_1/Miller_Freeman/MF0710/EK60/HAKE2007-D20070708-T200449.zarr'},
            },
            update_expression=(
                'SET '
                '#CH = :ch, '
