...
from src.model.index.index import IndexManager
...
#     )
#
#     all_ek60_data = index_manager.index()
#     print(all_ek60_data)
...
#  need to check each cruise has same number of files in noaa-wcsd-pds and noaa-wcsd-zarr-pds buckets