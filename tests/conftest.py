...
HB0707_RAW = pooch.create(
    ...
    base_url="https://noaa-wcsd-pds.s3.amazonaws.com/index.html#data/raw/Henry_B._Bigelow/HB0707/EK60/",
    retry_if_failed=1,
    registry={
        ...
        "D20070712-T152416.raw": "sha256:94a937eefd6ae5763c27c9ba1e4769b2b76fcc2d840e7db6c2e0edd925d6f70f", # 1000 m
        ...
        #"D20070712-T171804.raw": "sha256:03f5b44056373485aa01a3a7c10a761b0e61b81443b987a1a96d7c35076a13d3",
    },
)

# def fetch_raw_files():
#     fname1 = HB0707_RAW.fetch(fname="D20070712-T100505.raw", progressbar=True)
#     fname2 = HB0707_RAW.fetch(fname="D20070712-T152416.raw", progressbar=True)
#     fname3 = HB0707_RAW.fetch(fname="D20070712-T100505.raw", progressbar=True)
#     return Path(fname1).parent #joinpath(Path(file_path).stem)
#
# level_0_test_files = fetch_raw_files()
#
#
...
#         RESAMPLE_REGRID_TEST_PATH': level_0_test_files,
